...
;WITH CustomerTotal AS (
    SELECT 
        ordTotal.CustomerID,
        SUM(Total.UnitPrice * Total.Quantity) as TotalAmount
    FROM Sales.OrderLines AS Total
...
JOIN CustomerTotal AS ct ON ct.CustomerID = ord.CustomerID  -- Исправлено: ord.CustomerID вместо Inv.CustomerID
WHERE Inv.BillToCustomerID != ord.CustomerID
